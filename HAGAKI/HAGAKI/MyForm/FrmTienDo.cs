    ...
    public partial class FrmTienDo : XtraForm
    {
        ...
        private void ThongKe()
        {
            try
            {
                ...
                series1.ValueDataMembers.AddRange("soluong");chartControl1.Series.Add(series1);
        ...
        {
            lb_soHinhUserGood.Text = (from w in Global.Db.tbl_Images where w.ReadImageDEJP ==0 & w.fbatchname == cbb_Batch.Text select w).Count().ToString();
            ThongKe();
        }
